...
public class Principal extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int i) {
        if(i==R.id.rb_esp){
            ...
            txtV_nom.setText(R.string.eti_nom_sp);
            ...
            edtxt_nom.setHint(R.string.hint_nom_sp);
            edtxt_ape.setHint(R.string.hint_ape_sp);
            edtxt_edad.setHint(R.string.hint_edad_sp);
        }else{
            ...
            edtxt_nom.setHint(R.string.hint_nom_in);
            edtxt_ape.setHint(R.string.hint_ape_in);
            edtxt_edad.setHint(R.string.hint_edad_in);
        }
    }
}
